...
export default function ContactPage() {
  ...
  return (
    <AuthProvider>
      <CartProvider>
        <div className="min-h-screen bg-gray-50">         
          <main className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-10 lg:py-12">
            <div className="text-center mb-8 sm:mb-10 lg:mb-12">
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">Əlaqə</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12">
              ...
              <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8">
                <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">Əlaqə Məlumatları</h2>
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 text-sm sm:text-base">E-mail</h3>
                      <a 
                  ...
                  {settings?.address && (
                    <div className="flex items-start space-x-3 sm:space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Ünvan</h3>
                        <p className="text-gray-600 text-sm sm:text-base">{settings.address}</p>
                        <a 
                          href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(settings.address)}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-blue-600 hover:text-blue-800 transition-colors text-xs sm:text-sm mt-1 inline-flex items-center"
                        >
                  ...
                  {settings?.working_hours && (
                    <div className="flex items-start space-x-3 sm:space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 text-sm sm:text-base">İş Saatları</h3>
                        <p className="text-gray-600 text-sm sm:text-base">{settings.working_hours}</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              {/* Əlaqə formu */}
              <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8">
                <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">Mesaj Göndərin</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                  ...
                  <button
                    ...
                    className={`w-full py-2 sm:py-3 px-4 sm:px-6 rounded-md font-semibold transition duration-300 text-sm sm:text-base ${
                      isSubmitting
