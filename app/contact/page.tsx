            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+994 12 555 55 55</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:demo1@dostum.az" className="text-blue-600 hover:text-blue-800 transition-colors">
                    demo1@dostum.az
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Baku/Surakhanı/Hovsan</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Bazar ertəsi - Cümə: 09:00-18:01</p>
                </div>
              </div>
            </div>
          </div>
