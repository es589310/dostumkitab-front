    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-8 sm:py-10 lg:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 sm:gap-8">
          ...
          <div className="col-span-1 sm:col-span-2 md:col-span-2 lg:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <Link href="/" className="hover:opacity-80 transition-opacity">
                {settingsLoading ? (
                  <div className="h-8 w-24 sm:h-10 sm:w-32 md:h-12 md:w-40 lg:h-[39px] lg:w-[250px] bg-gray-700 animate-pulse rounded"></div>
                  ...
                  <div className="h-8 w-24 sm:h-10 sm:w-32 md:h-12 md:w-40 lg:h-[39px] lg:w-[250px] bg-gray-700 rounded flex items-center justify-center">
                    <span className="text-white font-bold text-xs sm:text-sm md:text-base lg:text-lg px-2 text-center">
            ...
            {settings?.address && (
              <div className="flex items-start text-xs sm:text-sm text-gray-300 mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-3 w-3 sm:h-4 sm:w-4 mr-2 mt-0.5 flex-shrink-0">
            ...
            {settings?.working_hours && (
              <div className="flex items-start text-xs sm:text-sm text-gray-300 mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-3 w-3 sm:h-4 sm:w-4 mr-2 mt-0.5 flex-shrink-0">
            ...
            <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-2 sm:space-y-0">
              <div className="flex items-center text-xs sm:text-sm text-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-3 w-3 sm:h-4 sm:w-4 mr-2">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">Sürətli Keçidlər</h3>
          ...
          {/* Customer Service */}
          <div>
            <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">Müştəri Xidməti</h3>
            <ul className="space-y-1 sm:space-y-2 text-xs sm:text-sm lg:text-base text-gray-300">
              <li>
          ...
          {/* Social Media */}
          <div>
            <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">Sosial Media</h3>
